...
const LoanProducts = () => {
    ...
    useEffect(() => {
        ...
        const id = window.setTimeout(() => setIsTransitioning(false), 450);
        return () => window.clearTimeout(id);
    }, [isTransitioning, activeLoan]);
    ...
    const handleLoanSelect = (nextKey: LoanKey) => {
        ...
        const currentIndex = navItems.findIndex((item) => item.key === activeLoan);
        const nextIndex = navItems.findIndex((item) => item.key === nextKey);
        ...
        <section ref={sectionRef} className="w-full bg-white px-5 py-16 sm:px-8 lg:px-10">
            <div className="mx-auto max-w-5xl">
                ...
                <motion.div
                    ...
                    className="mt-8"
                >
                    <div className={`overflow-hidden rounded-3xl bg-white shadow-[0_4px_40px_rgba(20,24,82,0.08)] transition-all duration-500 ease-out will-change-transform ${contentTransitionClass}`}>
                        <div className="grid grid-cols-1 lg:grid-cols-2 mb-5">
                            <div className="flex flex-col justify-center p-6 sm:p-8 lg:p-10">
                                ...
                                <p className="mt-5 text-[13.5px] leading-relaxed text-primary">
                                ...
                                <div className="mt-7 flex flex-col gap-3 sm:flex-row">
                                    ...
                                    <button className="rounded-full border border-[#141852]/15 px-5 py-2.5 text-sm font-medium text-[#141852] transition hover:bg-[#141852]/5">
                ...
                <div className="mt-6 grid grid-cols-1 gap-5 lg:grid-cols-3">
                    ...
                    <motion.div
                        ...
                        className="flex flex-col items-center justify-center gap-4 rounded-2xl bg-gray p-6 text-center"
                    >
                        <div className="flex h-10 w-10 items-center justify-center rounded-full bg-gray-200 border border-white text-primary shadow-xl">
                            <ArrowRightFromLine className="h-4 w-4 transition group-hover:translate-x-1" />
                        </div>
                        <div className="flex flex-col items-center gap-2">
                            {activeContent.audience.map((person) => (
                                <span key={person} className="rounded-full bg-white px-4 py-1.5 text-[12.5px] font-medium text-primary">
                                    {person}
                                </span>
                            ))}
                        </div>
