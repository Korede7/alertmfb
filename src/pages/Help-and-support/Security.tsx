...
const Security = () => {
    ...
    return (
        <motion.div
            ...
            className="w-full bg-white  px-6 p-5 pt-10 sm:pt-20 pb-20"
        >
            <div className="max-w-6xl mx-auto">
                ...
                >
                    <motion.span
                        ...
                        viewport={{ once: true }}
                        className="inline-block text-secondary font-semibold tracking-[0.10em] mb-3"
                    >
                        SECURITY
                    </motion.span>
                </motion.div>
                ...
                >
                    ...
                    >
                        ...
                        <motion.div
                            ...
                            className="bg-gray block sm:hidden lg:block rounded-2xl overflow-hidden h-[320px] flex items-center justify-center relative"
                        >
                            <AnimatePresence mode="wait">
                                <motion.img
                                    ...
                                    className="w-full h-60 object-fit mt-20"
                                />
                            </AnimatePresence>
                        ...
                        <motion.div
                            ...
                            className="bg-gray rounded-2xl p-4 transition-all duration-300"
                        >
                            <motion.h3
                                initial={{ opacity: 0 }}
