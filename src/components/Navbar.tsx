            ...
            <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-6 sm:px-8 lg:px-10">
                ...
                <div className="hidden items-center gap-8 lg:flex lg:gap-12">
                    ...
                    <div className="flex items-center gap-3">
                        {/* Join Alert */}
                        <button className={`h-11 rounded-full border px-8 text-[15px] font-medium transition hover:bg-[#F6F6FB] ${theme.buttonClass}`}>
                            Join Alert
                        </button>
                ...
                {mobileMenuOpen && (
                    <>
                        ...
                        <motion.div
                            ...
                            className={`fixed top-0 left-0 h-full w-80 max-w-[80%] z-50 lg:hidden shadow-2xl transition-colors duration-300 ${
                        ...
                        >
                            <div className="flex flex-col h-full p-6 pt-20 overflow-y-auto">
                                ...
                                <div className="flex flex-col gap-3">
                                    <button className={`h-11 rounded-full border px-8 text-[15px] font-medium transition hover:bg-[#F6F6FB] ${theme.buttonClass === "border-white text-white hover:bg-white/10" ? "border-[#1A1B67] text-[#1A1B67] hover:bg-[#F6F6FB]" : theme.buttonClass}`}>
                                        Join Alert
                                    </button>
